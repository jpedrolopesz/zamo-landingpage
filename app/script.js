    ...
    (cardId, index) => {
      ...
      ScrollTrigger.create({
        ...
        onLeave: () => {
          ...
          const servicesReact = servicesSection.getBoundingClientRect();
          const servicesTop = window.pageYOffset + servicesReact.top;
          ...
          ["#card-1", "#card-2", "#card-3"].forEach((cardId, index) => {
            ...
            if (cardProgress < 0.6) {
              ...
              rotate = gsap.utils.interpolate(
               index === 0 ? -5 : index === 1 ? 0 : 5, index === 2 ? 5 : 0, index === 3 ? -5 : 0,
               0,
                smoothStep(normalizedProgress)
              );
